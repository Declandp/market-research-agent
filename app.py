...
def run_research(company: str, competitors: list[str], progress_placeholder):
    ...
    progress_placeholder.info("🔧 Initializing AI agents...")

    from src.crew import MarketResearchCrew

    crew = MarketResearchCrew()

    progress_placeholder.info("🔍 **Scout Agent** is researching competitors...")
    ...
    if not company.strip():
        ...
        try:
            ...
            with agent_col1:
                ...
                scout_status.info("🔍 **Scout**: Researching...")
            ...
            # Update progress
            with agent_col1:
                scout_status.success("🔍 **Scout**: Complete!")
            progress_bar.progress(40)

            with agent_col2:
                agent_col2.success("📈 **Analyst**: Complete!")
            progress_bar.progress(70)

            with agent_col3:
                agent_col3.success("📝 **Reporter**: Complete!")
